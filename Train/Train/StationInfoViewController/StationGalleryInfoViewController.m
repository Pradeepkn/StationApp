...
- (void)getStationTasks {
    ...
    [[APIManager sharedInstance]makeAPIRequestWithObject:stationGalleryApi shouldAddOAuthHeader:NO andCompletionBlock:^(NSDictionary *responseDictionary, NSError *error) {
        ...
        if (!error) {
            ...
            weakSelf.averageDailyFootFallLabel.attributedText = [AppUtilityClass updateBoldFontForText:[stationGalleryApi.avgPassengerFootfail stringByReplacingOccurrencesOfString:@"Average Passanger Footfail" withString:@""] withLightFontForText:@"Average Passenger Footfall"];
