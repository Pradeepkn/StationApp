...
+ (CustomAlertViewController *)sharedInstance{
    static CustomAlertViewController *sharedInstance = nil;
...
- (void)displayAlertViewOnView:(UIView *)baseView withModel:(CustomAlertModel *)alertModel andCallBack:(AlertButtonAction)onButtonClick {
...
- (void) showAlertTableViewOn:(UIView *)containerView withModel:(CustomAlertModel *)alertModel onCompletion:(AlertTableCellSelectionAction)onCompletion {
